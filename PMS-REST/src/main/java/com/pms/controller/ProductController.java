...
@GetMapping(value="/V1/products",produces="application/json",params="version=1")
...
@GetMapping(value="/V2/products",produces="application/xml",params="version=2")
public ResponseEntity<ProductListDTO> getProductsXML()
{
